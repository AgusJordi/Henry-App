...
export function CrearGrupo(props) { //recibe pms por props
    ...
    return (
        ...
        <div>
            ...
            <div>      
                ...
                <ModalUsersCheckbox users={props.students_from_cohorte} state={openModal} close={handleCloseModal} />
                <FormControl className={classes.formControl}>
                <InputLabel htmlFor="cohorte-native-simple">
                    Cohorte
                </InputLabel>
                <Select
                    native
                ...
                >
                    ...
                    {props.all_cohortes.map((cohorte) => (
                ...
                />
                <FormControl className={classes.formControl}>
                <InputLabel htmlFor="pm1-native-simple">
                    Pm 1
                </InputLabel>
                <Select
                    native
                ...
                <FormControl className={classes.formControl}>
                <InputLabel htmlFor="pm2-native-simple">
                    Pm 2
                </InputLabel>
                <Select
                    native
                ...
                <div>
                <a className={classes.a} href="#" onClick={() => handleOpenModal()}>Seleccionar alumnos</a>
                </div>
