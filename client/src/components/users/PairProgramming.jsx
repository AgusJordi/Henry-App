...
export default function PairProgramming() {
  ...
  return (
    ...
    <div className = "box">
    <div className = "boxt">
    <Typography className={classes.title} bgcolor="text.primary" gutterBottom>
    Pair Programming
    </Typography>
    </div>
    ...
    <Typography  variant="h5" component="h3">
          ...
          con los que deberás ponerte en contacto para programar una 
          reunión diaria donde podrán intercambiar sobre código.

          Todos los viernes deberás calificar el desempeño de tus
          compañeros de Pair-Programming ingresando a este enlace:
    </Typography>
