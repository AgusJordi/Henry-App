...
function Login({
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      emailR: Yup.string()
        ...
        .required("El Email no puede quedar vacio"),
  ...
  if (register === false) {
    Swal.fire({
      ...
      text:
        "Debes usuar el E-email con en que inscribiste al Challenge de Henry!",
      footer: "<span>Soy Henry</span>",
    });
    userRegisterError();
  }
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className={classesRegister.divFormRoot}>
                ...
                <TextField
                  ...
                  error={formik.errors.firstNameR}
                  helperText={formik.errors.firstNameR}
                />
              </div>
              <div className={classesRegister.divFormRoot}>
                ...
                <TextField
                  ...
                  fullWidth
                  onChange={formik.handleChange}
                  error={formik.errors.lastNameR}
                  helperText={formik.errors.lastNameR}
                />
              </div>
              <div className={classesRegister.divFormRoot}>
                <label htmlFor="lastName"></label>
                <TextField
                  ...
                  fullWidth
                  onChange={formik.handleChange}
                  error={formik.errors.passwordR}
                  helperText={formik.errors.passwordR}
                />
              </div>
              <div className={classesRegister.divFormRoot}>
                ...
                <TextField
                  ...
                  fullWidth
                  onChange={formik.handleChange}
                  error={formik.errors.cityR}
                  helperText={formik.errors.cityR}
                />
              </div>
              <div className={classesRegister.divFormRoot}>
                ...
                <TextField
                  ...
                  fullWidth
                  onChange={formik.handleChange}
                  error={formik.errors.provinceR}
                  helperText={formik.errors.provinceR}
                />
              </div>
              <div className={classesRegister.divFormRoot}>
                ...
                <TextField
                  ...
                  fullWidth
                  onChange={formik.handleChange}
                  error={formik.errors.countryR}
                  helperText={formik.errors.countryR}
                />
              </div>
              <div className={classesRegister.divFormRoot}>
                ...
                <TextField
                  ...
                  fullWidth
                  onChange={formik.handleChange}
                  error={formik.errors.emailR}
                  helperText={formik.errors.emailR}
                />
              </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    userLogIn: (input) =>
      dispatch(userLogIn(!input ? (input = global.datos) : input)),
